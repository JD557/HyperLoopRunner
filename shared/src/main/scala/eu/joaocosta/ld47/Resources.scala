...
object Resources {
  ...
  val ingameSound = MidiPlayer.loadSequence("ingame-music.mid")
  val gameoverSound = MidiPlayer.loadSequence("gameover.mid")
  val menuSound = MidiPlayer.loadSequence("menu.mid")
}
